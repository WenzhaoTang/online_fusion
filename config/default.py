...
# precision
_C.MODEL.FP16_ON = True
_C.MODEL.AGGREGATION_ON = False

# aggregation
_C.MODEL.AGGREGATION = CN()
_C.MODEL.AGGREGATION.MODE = 'transformer'

_C.MODEL.AGGREGATION.TRANSFORMER = CN()
_C.MODEL.AGGREGATION.TRANSFORMER.N_VIEWS = 5
_C.MODEL.AGGREGATION.TRANSFORMER.DEPTH = 1
_C.MODEL.AGGREGATION.TRANSFORMER.HEADS = 4
_C.MODEL.AGGREGATION.TRANSFORMER.DIM_HEAD=32
_C.MODEL.AGGREGATION.TRANSFORMER.MLP_DIM=32
_C.MODEL.AGGREGATION.TRANSFORMER.DROPOUT=0.0
_C.MODEL.AGGREGATION.TRANSFORMER.EMBED_DROPOUT=0.0
